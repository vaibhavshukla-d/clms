    ...
    const handleClick = async (e) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                // console.log(responseData[0]?.Status[0] == 1);
    ...
    return (
        <>
            <div className="min-h-screen flex items-center justify-center">
                <div
                    className="bg-white p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 rounded-lg shadow-md w-full sm:w-2/3 md:w-1/2 lg:w-1/3 xl:w-3/6 flex">
                    <div className="w-2/4 flex items-center justify-center"> {/* Centered the image */}
                        <img src={logo} alt="Logo" className="max-w-full max-h-full" width={200} height={200}/>
                    </div>
                    ...
                    <div className="w-2/4 pl-8">
                        ...
                        <div className="mb-4">
                            <label className="block text-gray-600 text-sm font-medium">Login ID</label>
                            <input
                                type="text"
